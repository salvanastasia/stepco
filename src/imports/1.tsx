...
export default function Component() {
  return (
    <div className="bg-[#1a1a1a] relative size-full" data-name="1">
      ...
      <div className="absolute left-[-10px] size-[414px] top-[219px]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 414 414">
          <circle cx="207" cy="207" fill="var(--fill-0, #333333)" id="Ellipse 1" opacity="0.2" r="206.5" stroke="var(--stroke-0, #EEEEEE)" />
        </svg>
      </div>
      <Container />
      <Container1 />
